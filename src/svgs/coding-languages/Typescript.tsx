...
const SvgTypescript = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <style>{".typescript_svg__st1{fill:#fff}"}</style>
    <g id="typescript_svg__XMLID_1_">
      <path
        id="typescript_svg__XMLID_2_"
      ...
      />
      <path
        id="typescript_svg__XMLID_3_"
        d="m148.2 251.2-.1 14.9h47.6v135h33.6v-135h47.5v-14.7c0-8.1-.2-14.9-.4-15.1s-29.1-.3-64.1-.3l-63.8.2z"
        className="typescript_svg__st1"
      />
      <path
        id="typescript_svg__XMLID_4_"
